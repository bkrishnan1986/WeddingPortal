...
namespace Happy.Weddings.Wallet.Service.Handlers.v1.MultiDetail
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Wallet.Service.Commands.v1.MultiDetail.DeleteMultiDetailsCommand, Happy.Weddings.Wallet.Core.DTO.Responses.APIResponse}" />
