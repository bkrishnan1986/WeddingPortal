...
namespace Happy.Weddings.Wallet.Service.Handlers.v1.MultiDetail
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Wallet.Service.Queries.v1.MultiDetail.GetAllMultiDetailsQuery, Happy.Weddings.Wallet.Core.DTO.Responses.APIResponse}" />
