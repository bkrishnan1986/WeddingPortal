...
namespace Happy.Weddings.Wallet.Service.Handlers.v1.MultiCode
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Wallet.Service.Commands.v1.MultiCode.CreateMultiCodeCommand, Happy.Weddings.Wallet.Core.DTO.Responses.APIResponse}" />
