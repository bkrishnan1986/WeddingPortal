...
namespace Happy.Weddings.Wallet.Service.Handlers.v1.MultiCode
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Wallet.Service.Queries.v1.MultiCode.GetMultiCodeQuery, Happy.Weddings.Wallet.Core.DTO.Responses.APIResponse}" />
