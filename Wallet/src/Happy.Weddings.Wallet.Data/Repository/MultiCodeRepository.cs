...
namespace Happy.Weddings.Wallet.Data.Repository
{
    ...
    /// </summary>
    /// <seealso cref="Happy.Weddings.Wallet.Data.Repository.RepositoryBase{Happy.Weddings.Wallet.Core.Entity.Multicode}" />
    /// <seealso cref="Happy.Weddings.Wallet.Core.Repository.IMultiCodeRepository" />
    public class MultiCodeRepository : RepositoryBase<Multicode>, IMultiCodeRepository
    {
        ...
        /// <returns></returns>
        public async Task<List<Multicode>> GetAllMultiCodes(MultiCodeParameters multiCodeParameters)
        {
        ...
        /// <returns></returns>
        public async Task<Multicode> GetMultiCode(string code)
        {
            var getMultiCodesParams = new object[]
            {
                new MySqlParameter("@p_Id", 0),
