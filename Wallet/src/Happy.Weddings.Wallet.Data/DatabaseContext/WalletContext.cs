...
namespace Happy.Weddings.Wallet.Data.DatabaseContext
{
    public partial class WalletContext : DbContext
    {
        ...
        /// <param name="IConfiguration">The configuration manager.</param>
        public WalletContext(
            DbContextOptions<WalletContext> options,
        ...
        public virtual DbSet<Wallets> Wallet { get; set; }
