...
//              |                         | CreatePaymentBookRequest --class
//----------------------------------------------------------------------------------------------
...
{
    /// <summary>
    /// This Class is used to map CreatePaymentBook Request
    /// </summary>
    public class CreatePaymentBookRequest
    {
        public List<CreatePaymentBook> Payment_Book { get; set; }
    }
    public class CreatePaymentBook
    {
