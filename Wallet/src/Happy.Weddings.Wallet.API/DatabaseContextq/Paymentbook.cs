...
namespace Happy.Weddings.Wallet.API.DatabaseContextq
{
    public partial class Paymentbook
    {
        ...
        public virtual Multidetail FinanceApprovalStatusNavigation { get; set; }
        public virtual Multidetail PackageTypeNavigation { get; set; }
        public virtual Multidetail PaymentModeNavigation { get; set; }
        public virtual Multidetail PaymentStatusNavigation { get; set; }
        public virtual Multidetail PaymentTypeNavigation { get; set; }
    }
}
