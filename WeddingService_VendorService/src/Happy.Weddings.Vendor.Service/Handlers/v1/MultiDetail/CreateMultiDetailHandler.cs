...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.MultiDetail
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Vendor.Service.v1.Queries.CreateMultiDetailsCommand, Happy.Weddings.Vendor.Core.DTO.Responses.APIResponse}" />
