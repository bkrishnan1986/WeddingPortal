...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.MultiCode
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Vendor.Service.v1.Queries.GetAllMultiCodeQuery, Happy.Weddings.Vendor.Core.DTO.Responses.APIResponse}" />
    public class GetAllMultiCodesHandler : IRequestHandler<GetAllMultiCodesQuery, APIResponse>
    {
        ...
        {                   
            ...
            {
                logger.Error(ex, "Exception in method 'GetAllMultiCodeHandler()'");
