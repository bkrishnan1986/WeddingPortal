...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.MultiCode
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Vendor.Service.v1.Commands.UpdateStoryCommand, Happy.Weddings.Vendor.Core.DTO.Responses.APIResponse}" />
