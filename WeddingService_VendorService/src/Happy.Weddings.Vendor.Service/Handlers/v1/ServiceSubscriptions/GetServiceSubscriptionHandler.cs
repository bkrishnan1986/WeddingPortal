...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.ServiceSubscriptions
{
    ...
    public class GetServiceSubscriptionHandler : IRequestHandler<GetServiceSubscriptionQuery, APIResponse>
    {
        /// <summary>
        /// The repository
        /// </summary>
        ...
        public GetServiceSubscriptionHandler(
        ...
        /// </returns>
        public async Task<APIResponse> Handle(GetServiceSubscriptionQuery request, CancellationToken cancellationToken)
        {
            try
            {
                var servicesubscription = await repository.ServiceSubscriptions.GetServiceSubscriptionById(request.ServiceSubscriptionId);
