...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.ServiceSubscriptions
{
    ...
    public class UpdateServiceSubscriptionHandler : IRequestHandler<UpdateServiceSubscriptionCommand, APIResponse>
    {
        /// <summary>
        /// The repository
        /// </summary>
        ...
        public UpdateServiceSubscriptionHandler(
        ...
        /// </returns>
        public async Task<APIResponse> Handle(UpdateServiceSubscriptionCommand request, CancellationToken cancellationToken)
        {
            try
            {
                var vendorSubscription = await repository.ServiceSubscriptions.GetServiceSubscriptionById(request.ServiceSubscriptionId);
                ...
                repository.ServiceSubscriptions.UpdateServiceSubscription(vendorSubscriptionRequest);
