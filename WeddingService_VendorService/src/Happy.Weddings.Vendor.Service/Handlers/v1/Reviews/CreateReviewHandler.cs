...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.Reviews
{
    ...
    public class CreateReviewHandler : IRequestHandler<CreateReviewCommand, APIResponse>
    {
        /// <summary>
        /// The repository
        /// </summary>
        ...
        public async Task<APIResponse> Handle(CreateReviewCommand request, CancellationToken cancellationToken)
        {
            try
            {
                var offerRequest = mapper.Map<Review>(request.Request);
                repository.Reviews.CreateReview(offerRequest);
            ...
            {
                logger.Error(ex, "Exception in method 'CreateReviewHandler()'");
