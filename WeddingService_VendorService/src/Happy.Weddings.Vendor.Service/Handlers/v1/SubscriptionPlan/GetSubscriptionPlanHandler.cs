...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.SubscriptionPlan
{
    ...
    public class GetSubscriptionPlanHandler : IRequestHandler<GetSubscriptionPlanQuery, APIResponse>
    {
        /// <summary>
        /// The repository
        /// </summary>
        ...
        public GetSubscriptionPlanHandler(
        ...
        /// </returns>
        public async Task<APIResponse> Handle(GetSubscriptionPlanQuery request, CancellationToken cancellationToken)
        {
            try
            {
