...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.SubscriptionPlan
{
    ...
    public class UpdateSubscriptionPlanHandler : IRequestHandler<UpdateSubscriptionPlanCommand, APIResponse>
    {
        /// <summary>
        /// The repository
        /// </summary>
        ...
        /// </returns>
        public async Task<APIResponse> Handle(UpdateSubscriptionPlanCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                repository.SubscriptionPlans.UpdateSubscriptionPlan(storyRequest);
