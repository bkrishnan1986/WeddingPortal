...
namespace Happy.Weddings.Vendor.Service.Handlers.v1.VendorSubscriptions
{
    /// <summary>
    ...
    public class GetTopUpBenefitHandler : IRequestHandler<GetTopUpBenefitQuery, APIResponse>
    {
        /// <summary>
        /// The repository
        /// </summary>
        ...
        /// </returns>
        public async Task<APIResponse> Handle(GetTopUpBenefitQuery request, CancellationToken cancellationToken)
        {
            try
            {
