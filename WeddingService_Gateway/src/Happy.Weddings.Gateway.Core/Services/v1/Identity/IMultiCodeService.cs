...
namespace Happy.Weddings.Gateway.Core.Services.v1.Identity
{
    ...
    public interface IMulticodeService
    {
        ...
        /// <returns></returns>
        Task<APIResponse> CreateMultiCode(CreateMulticodeIdentityRequest request);
        ...
        /// <param name="request">The request.</param>
        /// <returns></returns>
        Task<APIResponse> UpdateMultiCode(MulticodeIdDetails details, UpdateMulticodeIdentityRequest request);
