...
namespace Happy.Weddings.Gateway.Core.Services.v1.Wallet
{
    ...
    public interface IMulticodeService
    {
        ...
        /// <returns></returns>
        Task<APIResponse> CreateMultiCode(CreateMulticodeWalletRequest request);
        ...
        /// <param name="request">The request.</param>
        /// <returns></returns>
        Task<APIResponse> UpdateMultiCode(MulticodeIdDetails details, UpdateMulticodeWalletRequest request);
