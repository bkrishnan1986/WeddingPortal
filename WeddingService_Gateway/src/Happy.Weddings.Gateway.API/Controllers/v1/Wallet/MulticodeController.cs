...
namespace Happy.Weddings.Gateway.API.Controllers.v1.Wallet
{
    ...
    public class MulticodeController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMultiCode([FromBody] CreateMulticodeWalletRequest request)
        {
        ...
        [HttpPut]
        //[Authorize(Roles = "Admin, Vendor")]
        public async Task<IActionResult> UpdateMultiCode(string code, [FromBody] UpdateMulticodeWalletRequest request)
        {
