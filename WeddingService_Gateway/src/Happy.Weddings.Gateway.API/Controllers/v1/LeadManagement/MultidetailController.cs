...
namespace Happy.Weddings.Gateway.API.Controllers.v1.LeadManagement
{
    ...
    [Route("api/v1/lead-management/multidetails")]
    [ApiController]
    public class MultidetailController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMultiDetails([FromBody] CreateMultidetailLeadRequest request)
        {
        ...
        [HttpPut]
        //[Authorize(Roles = "Admin, Vendor")]
        public async Task<IActionResult> UpdateMultiDetails(int multidetailId, [FromBody] UpdateMultidetailLeadRequest request)
        {
