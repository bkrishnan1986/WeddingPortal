...
namespace Happy.Weddings.Gateway.API.Controllers.v1.LeadManagement
{
    ...
    [Route("api/v1/lead-management/multicode")]
    [ApiController]
    public class MulticodeController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMultiCode([FromBody] CreateMulticodeLeadRequest request)
        {
        ...
        [HttpPut]
        //[Authorize(Roles = "Admin, Vendor")]
        public async Task<IActionResult> UpdateMultiCode(string code, [FromBody] UpdateMulticodeLeadRequest request)
        {
