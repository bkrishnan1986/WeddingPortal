...
namespace Happy.Weddings.Gateway.API.Controllers.v1.Blog
{
    ...
    public class MulticodeController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMultiCode([FromBody] CreateMulticodeBlogRequest request)
        {
        ...
        [HttpPut]
        //[Authorize(Roles = "Admin, Vendor")]
        public async Task<IActionResult> UpdateMultiCode(string code, [FromBody] UpdateMulticodeBlogRequest request)
        {
