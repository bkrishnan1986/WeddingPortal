...
namespace Happy.Weddings.Gateway.API.Controllers.v1.Blog
{
    ...
    public class StoriesController : ControllerBase
    {
        ...
        /// <param name="storyId">The story identifier.</param>
        /// <returns></returns>
        [Route("{storyId}/taggeddata")]
        [HttpGet]
        public async Task<IActionResult> GetTaggedDataByStoryId(int storyId)
        {
            var result = await storyService.GetTaggedDataByStoryId(new StoryIdDetails(storyId));
