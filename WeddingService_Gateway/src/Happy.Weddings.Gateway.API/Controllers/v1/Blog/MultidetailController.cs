...
namespace Happy.Weddings.Gateway.API.Controllers.v1.Blog
{
    ...
    public class MultidetailController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMultiDetails([FromBody] CreateMultidetailBlogRequest request)
        {
        ...
        [HttpPut]
        //[Authorize(Roles = "Admin, Vendor")]
        public async Task<IActionResult> UpdateMultiDetails(int multidetailId, [FromBody] UpdateMultidetailBlogRequest request)
        {
