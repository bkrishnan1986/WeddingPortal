...
namespace Happy.Weddings.Gateway.API.Controllers.v1.Identity
{
    ...
    public class MulticodeController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMultiCode([FromBody] CreateMulticodeIdentityRequest request)
        {
        ...
        [HttpPut]
        //[Authorize(Roles = "Admin, Vendor")]
        public async Task<IActionResult> UpdateMultiCode(string code, [FromBody] UpdateMulticodeIdentityRequest request)
        {
