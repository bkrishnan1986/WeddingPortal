...
namespace Happy.Weddings.Gateway.API.Controllers.v1.Identity
{
    ...
    public class MultidetailController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateMultiDetails([FromBody] CreateMultidetailIdentityRequest request)
        {
        ...
        [HttpPut]
        //[Authorize(Roles = "Admin, Vendor")]
        public async Task<IActionResult> UpdateMultiDetails(int multidetailId, [FromBody] UpdateMultidetailIdentityRequest request)
        {
