    ...
    public class MultidetailService : IMultidetailService
    {
        ...
        public async Task<APIResponse> GetAllMultiDetails(MultidetailParameter multidetailParameter)
        {
            try
            {
                ...
                UriBuilder url = new UriBuilder(servicesConfig.AuditLog + AuditLogServiceOperation.GetAllMultiDetails());
        ...
        public async Task<APIResponse> GetMultiDetailsById(MulticodeIdDetails details)
        {
            try
            {
                ...
                var response = await client.GetAsync(servicesConfig.AuditLog + AuditLogServiceOperation.GetMultiDetailsById(details.MulticodeId));
        ...
        /// <returns></returns>
        public async Task<APIResponse> CreateMultiDetails(CreateMultidetailAuditLogRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(AuditLogServiceOperation.serviceName);
                ...
                var response = await client.PostAsync(servicesConfig.AuditLog + AuditLogServiceOperation.CreateMultiDetails(), contentPost);
        ...
        /// <param name="request">The request.</param>
        /// <returns></returns>
        public async Task<APIResponse> UpdateMultiDetails(MultidetailIdDetails details, UpdateMultidetailAuditLogRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(AuditLogServiceOperation.serviceName);
                ...
                var response = await client.PutAsync(servicesConfig.AuditLog + AuditLogServiceOperation.UpdateMultiDetails(details.MultidetailId), contentPost);
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
        ...
        public async Task<APIResponse> DeleteMultiDetails(MultidetailIdDetails details)
        {
            try
            {
                ...
                var response = await client.DeleteAsync(servicesConfig.AuditLog + AuditLogServiceOperation.DeleteMultiDetails(details.MultidetailId));
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
