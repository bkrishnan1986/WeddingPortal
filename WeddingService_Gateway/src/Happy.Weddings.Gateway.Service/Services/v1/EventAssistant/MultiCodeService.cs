    ...
    public class MulticodeService : IMulticodeService
    {
        ...
        public async Task<APIResponse> GetAllMultiCodes(MulticodeParameter multicodeParameter)
        {
            try
            {
                ...
                UriBuilder url = new UriBuilder(servicesConfig.Lead + EventAssistantServiceOperation.GetAllMultiCodes());
                url.Query = QueryStringHelper.ConvertToQueryString(multicodeParameter);
                var response = await client.GetAsync(url.ToString());
        ...
        public async Task<APIResponse> GetMultiCode(MulticodeIdDetail details)
        {
            try
            {
                ...
                var response = await client.GetAsync(servicesConfig.EventAssistant + EventAssistantServiceOperation.GetMultiCode(details.Code));
        ...
        /// <returns></returns>
        public async Task<APIResponse> CreateMultiCode(CreateMulticodeEventAssistantRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(EventAssistantServiceOperation.serviceName);
                ...
                var response = await client.PostAsync(servicesConfig.EventAssistant + EventAssistantServiceOperation.CreateMultiCode(), contentPost);
                if (response.IsSuccessStatusCode)
                {
        ...
        /// <param name="request">The request.</param>
        /// <returns></returns>
        public async Task<APIResponse> UpdateMultiCode(MulticodeIdDetail details, UpdateMulticodeEventAssistantRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(EventAssistantServiceOperation.serviceName);
                ...
                var response = await client.PutAsync(servicesConfig.EventAssistant + EventAssistantServiceOperation.UpdateMultiCode(details.Code), contentPost);
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
        ...
        public async Task<APIResponse> DeleteMultiCode(MulticodeIdDetail details)
        {
            try
            {
                ...
                var response = await client.DeleteAsync(servicesConfig.EventAssistant + EventAssistantServiceOperation.DeleteMultiCode(details.Code));
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
