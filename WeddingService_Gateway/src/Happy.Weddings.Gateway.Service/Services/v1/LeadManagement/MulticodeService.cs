    ...
    public class MulticodeService : IMulticodeService
    {
        ...
        public async Task<APIResponse> GetAllMultiCodes(MulticodeParameter multicodeParameter)
        {
            try
            {
                ...
                UriBuilder url = new UriBuilder(servicesConfig.Lead + LeadServiceOperation.GetAllMultiCodes());
                url.Query = QueryStringHelper.ConvertToQueryString(multicodeParameter);
                var response = await client.GetAsync(url.ToString());
        ...
        public async Task<APIResponse> GetMultiCode(MulticodeIdDetails details)
        {
            try
            {
                ...
                var response = await client.GetAsync(servicesConfig.Lead + LeadServiceOperation.GetMultiCode(details.Code));
        ...
        /// <returns></returns>
        public async Task<APIResponse> CreateMultiCode(CreateMulticodeLeadRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(LeadServiceOperation.serviceName);
                ...
                var response = await client.PostAsync(servicesConfig.Lead +LeadServiceOperation.CreateMultiCode(), contentPost);
                if (response.IsSuccessStatusCode)
                {
        ...
        /// <param name="request">The request.</param>
        /// <returns></returns>
        public async Task<APIResponse> UpdateMultiCode(MulticodeIdDetails details, UpdateMulticodeLeadRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(LeadServiceOperation.serviceName);
                ...
                var response = await client.PutAsync(servicesConfig.Lead + LeadServiceOperation.UpdateMultiCode(details.Code), contentPost);
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
        ...
        public async Task<APIResponse> DeleteMultiCode(MulticodeIdDetails details)
        {
            try
            {
                ...
                var response = await client.DeleteAsync(servicesConfig.Lead + LeadServiceOperation.DeleteMultiCode(details.Code));
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
