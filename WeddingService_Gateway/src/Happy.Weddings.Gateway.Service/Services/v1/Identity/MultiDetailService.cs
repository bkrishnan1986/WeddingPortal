...
namespace Happy.Weddings.Gateway.Service.Services.v1.Identity
{
    ...
    public class MultidetailService : IMultidetailService
    {
        ...
        //        var encodedMultidetail = await distributedCache.GetAsync(IdentityServiceOperation.GetWalletCacheName);
        ...
        //            UriBuilder url = new UriBuilder(servicesConfig.Wallet + IdentityServiceOperation.GetAllMultiDetails());
        ...
        //            await distributedCache.SetAsync(IdentityServiceOperation.GetWalletCacheName, encodedMultidetail, options);
        //        }
        ...
        public async Task<APIResponse> GetAllMultiDetails(MultidetailParameter multidetailParameter)
        {
            try
            {
                ...
                UriBuilder url = new UriBuilder(servicesConfig.Wallet + IdentityServiceOperation.GetMultiDetails());
                url.Query = QueryStringHelper.ConvertToQueryString(multidetailParameter);
                var response = await client.GetAsync(url.ToString());
        ...
        public async Task<APIResponse> GetMultiDetailsByCode(string Code)
        {
            try
            {
                ...
                var response = await client.GetAsync(servicesConfig.Wallet + IdentityServiceOperation.GetMultiDetailsById(Code));
        ...
        /// <returns></returns>
        public async Task<APIResponse> CreateMultiDetails(CreateMultidetailIdentityRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(IdentityServiceOperation.serviceName);
                ...
                var response = await client.PostAsync(servicesConfig.Wallet + IdentityServiceOperation.CreateMultiDetails(), contentPost);
        ...
        /// <param name="request">The request.</param>
        /// <returns></returns>
        public async Task<APIResponse> UpdateMultiDetails(MultidetailIdDetails details, UpdateMultidetailIdentityRequest request)
        {
            try
            {
                var client = httpClientFactory.CreateClient(IdentityServiceOperation.serviceName);
                ...
                var response = await client.PutAsync(servicesConfig.Wallet + IdentityServiceOperation.UpdateMultiDetails(details.MultidetailId), contentPost);
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
        ...
        public async Task<APIResponse> DeleteMultiDetails(MultidetailIdDetails details)
        {
            try
            {
                ...
                var response = await client.DeleteAsync(servicesConfig.Wallet + IdentityServiceOperation.DeleteMultiDetails(details.MultidetailId));
                return new APIResponse(response.StatusCode);
            }
            catch (Exception ex)
            {
