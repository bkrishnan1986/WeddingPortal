...
namespace Happy.Weddings.LeadManagement.Service.Handlers.v1.Lead
{
    ...
    /// </summary>
    public class GetAllLeadQuoteHandler : IRequestHandler<GetAllLeadQuotesQuery, APIResponse>
    {
        /// <summary>
        /// The repository
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<APIResponse> Handle(GetAllLeadQuotesQuery query, CancellationToken cancellationToken)
        {
            try
            {
                var leadQuotes = await repository.LeadQuoteRepository.GetLeadQuotes(query.LeadQuoteParameters, query.LeadId);
            ...
            {
                logger.Error(ex, "Exception in method 'GetAllLeadQuoteHandler");
