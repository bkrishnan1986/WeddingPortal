...
{
    /// <summary>
    /// Handler for getting  multidetail by Id
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Identity.Service.Queries.v1.MultiDetail.GetMultiDetailsByIdQuery, Happy.Weddings.Identity.Core.DTO.Responses.APIResponse}" />
