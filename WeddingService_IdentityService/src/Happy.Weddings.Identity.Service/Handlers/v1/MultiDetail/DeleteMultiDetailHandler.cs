...
namespace Happy.Weddings.Identity.Service.Handlers.v1.MultiDetail
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Identity.Service.Commands.v1.MultiDetail.DeleteMultiDetailsCommand, Happy.Weddings.Identity.Core.DTO.Responses.APIResponse}" />
