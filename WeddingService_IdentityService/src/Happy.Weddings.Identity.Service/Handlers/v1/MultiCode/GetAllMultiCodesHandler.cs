...
namespace Happy.Weddings.Identity.Service.Handlers.v1.MultiCode
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Identity.Service.Queries.v1.MultiCode.GetAllMultiCodesQuery, Happy.Weddings.Identity.Core.DTO.Responses.APIResponse}" />
