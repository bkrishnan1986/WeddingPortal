...
namespace Happy.Weddings.Identity.Service.Handlers.v1.MultiCode
{
    ...
    /// </summary>
    /// <seealso cref="MediatR.IRequestHandler{Happy.Weddings.Identity.Service.Commands.v1.MultiCode.UpdateMultiCodeCommand, Happy.Weddings.Identity.Core.DTO.Responses.APIResponse}" />
