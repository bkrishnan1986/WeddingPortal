using Happy.Weddings.Identity.API.Extensions;
using Happy.Weddings.Identity.API.Filters;
...
namespace Happy.Weddings.Identity.API
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services
                .AddMVCConfiguration()
                .CreateAuthorization(Configuration,HostingEnvironment)
                .CreateResponseCompression()
                .AddSwaggerConfiguration(Configuration)
                .AddHealthCheck()
                .AddServicesInjection(HostingEnvironment, Configuration)
                .AddControllers(x => x.UseGeneralRoutePrefix(Configuration["Environment:RoutePrefix"]));
        }
